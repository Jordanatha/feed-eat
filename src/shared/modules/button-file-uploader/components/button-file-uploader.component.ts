...
@Component({
    selector: 'button-file-uploader',
    templateUrl: './button-file-uploader.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => ButtonFileUploaderComponent),
            multi: true,
        },
    ],
})
export class ButtonFileUploaderComponent implements ControlValueAccessor {
